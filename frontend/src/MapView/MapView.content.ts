...
const cities: CityDefinition[] = [
  ...
  },
  {
    key: '@5141',
    name: 'Murska Sobota',
    subtitle: 'Prekmurje region',
    position: { lat: 46.6620, lng: 16.1710 },
    aqi: null,
    heroImageUrl: '/cities/murskasobota.jpg',
    pinVariant: null,
    pollutants: {},
  },
  {
  ...
  },
  {
    key: '@14309',
    name: 'Jelenja Vas',
    subtitle: 'Kočevska region',
    position: { lat: 45.5647, lng: 14.8631 }, // Updated to match Iskrba station coordinates (heat source)
    aqi: null,
    heroImageUrl: '/cities/jelenjavas.jpg', 
    pinVariant: null,
    pollutants: {},
  },
];
